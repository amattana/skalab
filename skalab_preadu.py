...
#             self.records[num]['code'].setText(str(hex(register_value))[2:])
#             # Attenuation
#             #print(num, register_value, str(hex(register_value)), str(self.preadu.get_rx_attenuation(num)))
#             update_text(self.records[num]['att'], str(self.preadu.get_rx_attenuation(nrx=num)))
#             #update_text(self.records[num]['att'], str((register_value & 0b11111000) >> 3))
...
#             #conf_value = ('0x' + self.records[num]['code'].text()).toInt(16)[0] & 0b11111011
#             #conf_value = conf_value | 0b10
#             self.records[num]['code'].setFont(font_bold())
#             self.records[num]['code'].setText(hex(self.preadu.get_register_value(nrx=num))[2:])
#             update_flag_lo_filter(self.records[num], self.preadu.is_lopass(num))
#             update_flag_hi_filter(self.records[num], self.preadu.is_hipass(num))
...
#             #conf_value=('0x'+self.records[num]['code'].text()).toInt(16)[0] & 0b11111101
...
#         self.records[num]['code'].setFont(font_bold())
#         self.records[num]['code'].setText(hex(self.preadu.get_register_value(nrx=num))[2:])
#         self.records[num]['att'].setText(str(self.preadu.get_rx_attenuation(nrx=num)))
#
#     def action_minus(self, num):
#         valore = int(self.records[num]['att'].text()) - 1
#         if valore < 0:
...
#         if self.tpm is not None:
#             for i in range(CHANNELS):
#                 self.preadu.set_register_value(nrx=i, value=int("0x" + self.records[i]['code'].text(), 16))
#             self.write_armed = True
#
